...
//             .setData("verificationId", value: verificationId);

//         // Call verifyPhoneNumber with the verification ID and SMS code
...
//     var phoneNumber = await FirebaseFirestore.instance
//         .collection('users')
//         .doc(FirebaseAuth.instance.currentUser!.uid.toString())
//         .get();
//     print(phoneNumber);
//     if (phoneNumber.exists) {
//       var phone = phoneNumber.data()!['phone'];

//       print("obtained Phone: $phone");
//       await _auth.verifyPhoneNumber(
//         phoneNumber: phone,
//         verificationCompleted: (PhoneAuthCredential credential) async {
//           // ...
...
//     } else {
//       print('Phone number document does not exist');
//     }
...
//     try {
//       // ...
//       var very =await SharedHandler.instance!
...
//       // Verify the phone number using the credential
//       await _auth.signInWithCredential(credential);
...
//           errorMessege: 'Phone number verification failed'));
  ...
  Future<void> verifyPhoneNumber(verificationId, String smsCode) async {
    try {
      ...
      await _auth.signInWithCredential(credential).then((value) async{
        var verificatioupdate = "true";
        if (value.user != null) {
          DocumentReference userRef =await FirebaseFirestore.instance
              .collection('users')
              .doc(FirebaseAuth.instance.currentUser!.uid.toString());
          userRef.update({"isVerified": verificatioupdate}).then((value) {
            print("Field updated successfully");
          }).catchError((error) {
            emit(verificationFailure(
                errorMessege: 'Failed to Verify Try Again!'));
            print("Failed to update field: $error");
          });
          CustomNavigator.push(Routes.login);
        }
